...
class Scaffolding1 {
	...
	function Scaffolding1($db_table)
	{
		...
		$this->CI->load->_ci_view_path = BASEPATH.'application/views/scaffolding/views';
		...
		// Set a few globals
		$data = array(
						'image_url'	=> $this->CI->config->system_url().'application/views/scaffolding/images/',
