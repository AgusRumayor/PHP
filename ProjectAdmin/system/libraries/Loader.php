...
/**
	...
	{		
		...
		$CI =& get_instance();
		$CI->_ci_scaffolding_1 = TRUE;
		$CI->_ci_scaff_table_1 = $table;
	}
	// --------------------------------------------------------------------
	...
	{	
		...
		if (isset($autoload['libraries']) AND count($autoload['libraries']) > 0)
		{
			...
			// Load scaffolding_1
			if (in_array('scaffolding_1', $autoload['libraries']))
			{
				$this->scaffolding_1();
				$autoload['libraries'] = array_diff($autoload['libraries'], array('scaffolding_1'));
			}
